...
console.log(typeof faultyClone.date) // string
  ...
  // NB this code is only gotten in order to see how it works. It is not meant to be a homework problem. 
   //The purpose of it is to research and find out about shallow and deep copy of objects in js.